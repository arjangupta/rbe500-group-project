...
\begin{homeworkProblem}[Question 2]
    ...
    Next, we launced our forward kinematics calculation ROS node. The screenshots obtained are shown below.
    ...
    After this we launched the forward kinematics ROS node as well. The obtained screenshots are shown below.
    ...
    After this we launched the forward kinematics ROS node as well. The obtained screenshots are shown in Figure 8 on the previous page.
