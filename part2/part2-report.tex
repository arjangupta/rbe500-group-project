...
\begin{homeworkProblem}[Problem 1]
    ...
    function. We edited the package.xml and setup.py to make sure that we
    can build the basic package.

    Next, we added a new custom interface by editing our rbe500 custom interface
    ...
    This service call has the 3 joint variables in its request portion and a
    simple acknowledgement boolean inside its response portion.
\end{homeworkProblem}
