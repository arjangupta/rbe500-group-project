...
\begin{homeworkProblem}[Problem 1]
    ...
    \begin{itemize}
        ...
        of anything less than $-9.8 m/s^2$, and in order to hold the prismatic joint
        in that state, we needed to apply exactly $-9.8 m/s^2$ acceleration. Since our
        joint mass is simply 1, we were able to publish the joint effort as simply
        $-9.8$, for example.
    \end{itemize}
\end{homeworkProblem}
