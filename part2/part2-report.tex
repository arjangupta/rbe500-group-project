...
\begin{homeworkProblem}[Problem 1]
    ...
    deactivates the position and velocity controllers. We added this as the last
    task that the constructor of our Node performs because we need a blocking
    while-loop right after the client is created. This while loop continuously
    waits and checks if the target service is online. After the service becomes
